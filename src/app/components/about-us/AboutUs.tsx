        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full px-10">
          ...
          <div className="bg-secondary-color p-6 rounded-md shadow-md">
            ...
            <p className="text-gray-800">
              At [Your Job Platform Name], we are committed to connecting talented individuals with their dream careers. With a passion for innovation and excellence, we strive to redefine the job search experience.
            </p>
          </div>
